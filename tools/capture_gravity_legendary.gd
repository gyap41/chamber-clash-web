extends SceneTree
const OUT="res://docs/art/reviews/gravity-legendary-2026-09-13/"
const RAW="res://.local/gravity-legendary-frames/"
...
func run() -> void:
	...
	game.players[1].inventory=[game.Weapons.new_inventory_entry(0)]
	...
	for frame in range(96):
		if frame==0:game.fire(0)
		if frame%8==0:game.fire(1)
