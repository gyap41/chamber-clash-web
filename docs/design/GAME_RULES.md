...
更新: 2026-09-12。リファクタリングで現行ルール・数値・処理順を維持。
...
フィールド取得品は控えへ収納し、次の準備で形状を配置してから使用する。その場で戦闘性能は変わらない。後続のアイテム追加でP-12の発射間隔を0.29→0.38秒に変更した。
...
|31 ペッパーボックス|広く散る4発散弾。近距離で全弾命中すると2ダメージ。|ショップ／通常補給（C）|
